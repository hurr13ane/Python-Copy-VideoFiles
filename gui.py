...
see_file_button = tk.Button(buttons_frame, text="See files.txt", command=open_file, font=("Helvetica", 12), bg="#87CEFA", activebackground="#87CEFA", relief="groove", borderwidth=2)
